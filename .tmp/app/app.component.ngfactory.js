...
var _View_MyApp0 = (function (_super) {
    ...
    _View_MyApp0.prototype.createInternal = function (rootSelector) {
        ...
        this._Header_2_3 = new import16.Header(this.parentInjector.get(import26.Config), new import25.ElementRef(this._el_2), this.renderer, this.parentInjector.get(import30.ViewController, null));
        ...
        this._Toolbar_4_4 = new import16.Toolbar(this.parentInjector.get(import30.ViewController, null), this.parentInjector.get(import26.Config), new import25.ElementRef(this._el_4), this.renderer);
        ...
        this._ToolbarTitle_6_4 = new import17.ToolbarTitle(this.parentInjector.get(import26.Config), new import25.ElementRef(this._el_6), this.renderer, this._Toolbar_4_4, this.parentInjector.get(import33.Navbar, null));
        ...
        this._Content_11_4 = new import18.Content(this.parentInjector.get(import26.Config), new import25.ElementRef(this._el_11), this.renderer, this.parentInjector.get(import35.App), this.parentInjector.get(import27.Keyboard), this.parentInjector.get(import28.NgZone), this.parentInjector.get(import30.ViewController, null), this.parentInjector.get(import36.Tabs, null));
        ...
        var compView_23 = import39.viewFactory_Nav0(this.viewUtils, this.injector(23), this._appEl_23);
        this._Nav_23_4 = new import22.Nav(this.parentInjector.get(import30.ViewController, null), this.parentInjector.get(import40.NavControllerBase, null), this.parentInjector.get(import35.App), this.parentInjector.get(import26.Config), this.parentInjector.get(import27.Keyboard), new import25.ElementRef(this._el_23), this.parentInjector.get(import28.NgZone), this.renderer, this.parentInjector.get(import41.ComponentFactoryResolver), this.parentInjector.get(import29.GestureController), this.parentInjector.get(import42.TransitionController), this.parentInjector.get(import43.DeepLinker, null));
    ...
    _View_MyApp0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import16.Toolbar) && ((4 <= requestNodeIndex) && (requestNodeIndex <= 8)))) {
            return this._Toolbar_4_4;
        }
        if (((token === import16.Header) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 9)))) {
        ...
        if (((token === import21.NgFor) && (17 === requestNodeIndex))) {
            return this._NgFor_17_6;
        }
        if (((token === import19.List) && ((13 <= requestNodeIndex) && (requestNodeIndex <= 18)))) {
            return this._List_13_3;
        }
        if (((token === import18.Content) && ((11 <= requestNodeIndex) && (requestNodeIndex <= 19)))) {
            return this._Content_11_4;
        }
        if (((token === import15.Menu) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 20)))) {
            return this._Menu_0_4;
        }
        if (((token === import22.Nav) && (23 === requestNodeIndex))) {
...
var _View_MyApp1 = (function (_super) {
    ...
    _View_MyApp1.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import46.Icon) && (2 === requestNodeIndex))) {
        ...
        if (((token === import45.MenuClose) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 3)))) {
