...
var _View_MyApp0 = (function (_super) {
    ...
    _View_MyApp0.prototype.createInternal = function (rootSelector) {
        ...
        this._Header_2_3 = new import14.Header(this.parentInjector.get(import24.Config), new import23.ElementRef(this._el_2), this.renderer, this.parentInjector.get(import28.ViewController, null));
        ...
        var compView_4 = import29.viewFactory_Toolbar0(this.viewUtils, this.injector(4), this._appEl_4);
        this._Toolbar_4_4 = new import14.Toolbar(this.parentInjector.get(import28.ViewController, null), this.parentInjector.get(import24.Config), new import23.ElementRef(this._el_4), this.renderer);
        ...
        var compView_6 = import30.viewFactory_ToolbarTitle0(this.viewUtils, this.injector(6), this._appEl_6);
        this._ToolbarTitle_6_4 = new import15.ToolbarTitle(this.parentInjector.get(import24.Config), new import23.ElementRef(this._el_6), this.renderer, this._Toolbar_4_4, this.parentInjector.get(import31.Navbar, null));
        ...
        var compView_11 = import32.viewFactory_Content0(this.viewUtils, this.injector(11), this._appEl_11);
        this._Content_11_4 = new import16.Content(this.parentInjector.get(import24.Config), new import23.ElementRef(this._el_11), this.renderer, this.parentInjector.get(import33.App), this.parentInjector.get(import25.Keyboard), this.parentInjector.get(import26.NgZone), this.parentInjector.get(import28.ViewController, null), this.parentInjector.get(import34.Tabs, null));
    ...
    _View_MyApp0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import35.TemplateRef) && (17 === requestNodeIndex))) {
            return this._TemplateRef_17_5;
        }
        if (((token === import19.NgFor) && (17 === requestNodeIndex))) {
            return this._NgFor_17_6;
        }
        if (((token === import17.List) && ((13 <= requestNodeIndex) && (requestNodeIndex <= 18)))) {
            return this._List_13_3;
        }
        if (((token === import16.Content) && ((11 <= requestNodeIndex) && (requestNodeIndex <= 19)))) {
            return this._Content_11_4;
        }
        if (((token === import13.Menu) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 20)))) {
            return this._Menu_0_4;
        }
        if (((token === import20.Nav) && (23 === requestNodeIndex))) {
...
var _View_MyApp1 = (function (_super) {
    ...
    _View_MyApp1.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import44.Icon) && (2 === requestNodeIndex))) {
            return this._Icon_2_3;
        }
        if (((token === import42.Item) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 3)))) {
            return this._Item_0_4;
        }
        if (((token === import42.ItemContent) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 3)))) {
            return this._ItemContent_0_5;
        }
        if (((token === import43.MenuClose) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 3)))) {
