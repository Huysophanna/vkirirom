...
var _View_MyApp0 = (function (_super) {
    ...
    _View_MyApp0.prototype.createInternal = function (rootSelector) {
        ...
        this._appEl_0 = new import2.AppElement(0, null, this, this._el_0);
        var compView_0 = import22.viewFactory_Menu0(this.viewUtils, this.injector(0), this._appEl_0);
        ...
        this._Header_2_3 = new import15.Header(this.parentInjector.get(import25.Config), new import24.ElementRef(this._el_2), this.renderer, this.parentInjector.get(import29.ViewController, null));
        ...
        var compView_4 = import30.viewFactory_Toolbar0(this.viewUtils, this.injector(4), this._appEl_4);
        this._Toolbar_4_4 = new import15.Toolbar(this.parentInjector.get(import29.ViewController, null), this.parentInjector.get(import25.Config), new import24.ElementRef(this._el_4), this.renderer);
        ...
        var compView_6 = import31.viewFactory_ToolbarTitle0(this.viewUtils, this.injector(6), this._appEl_6);
        this._ToolbarTitle_6_4 = new import16.ToolbarTitle(this.parentInjector.get(import25.Config), new import24.ElementRef(this._el_6), this.renderer, this._Toolbar_4_4, this.parentInjector.get(import32.Navbar, null));
        ...
        var compView_11 = import33.viewFactory_Content0(this.viewUtils, this.injector(11), this._appEl_11);
        ...
        var compView_23 = import38.viewFactory_Nav0(this.viewUtils, this.injector(23), this._appEl_23);
        this._Nav_23_4 = new import21.Nav(this.parentInjector.get(import29.ViewController, null), this.parentInjector.get(import39.NavControllerBase, null), this.parentInjector.get(import34.App), this.parentInjector.get(import25.Config), this.parentInjector.get(import26.Keyboard), new import24.ElementRef(this._el_23), this.parentInjector.get(import27.NgZone), this.renderer, this.parentInjector.get(import40.ComponentFactoryResolver), this.parentInjector.get(import28.GestureController), this.parentInjector.get(import41.TransitionController), this.parentInjector.get(import42.DeepLinker, null));
    ...
    _View_MyApp0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import19.NgIf) && (15 === requestNodeIndex))) {
        ...
        if (((token === import18.List) && ((13 <= requestNodeIndex) && (requestNodeIndex <= 18)))) {
            return this._List_13_3;
        }
        if (((token === import17.Content) && ((11 <= requestNodeIndex) && (requestNodeIndex <= 19)))) {
            return this._Content_11_4;
        }
        if (((token === import14.Menu) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 20)))) {
            return this._Menu_0_4;
        }
        if (((token === import21.Nav) && (23 === requestNodeIndex))) {
...
var _View_MyApp1 = (function (_super) {
    ...
    _View_MyApp1.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import44.MenuClose) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 3)))) {
...
var _View_MyApp2 = (function (_super) {
    ...
    _View_MyApp2.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import43.Item) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) {
            return this._Item_0_4;
        }
        if (((token === import43.ItemContent) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) {
            return this._ItemContent_0_5;
        }
        if (((token === import44.MenuClose) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) {
            return this._MenuClose_0_6;
        }
        return notFoundResult;
    };
