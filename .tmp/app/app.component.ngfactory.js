...
var _View_MyApp0 = (function (_super) {
    ...
    _View_MyApp0.prototype.createInternal = function (rootSelector) {
        ...
        this._appEl_0 = new import2.AppElement(0, null, this, this._el_0);
        var compView_0 = import23.viewFactory_Menu0(this.viewUtils, this.injector(0), this._appEl_0);
        ...
        this._Header_2_3 = new import14.Header(this.parentInjector.get(import26.Config), new import25.ElementRef(this._el_2), this.renderer, this.parentInjector.get(import30.ViewController, null));
        ...
        this._Toolbar_4_4 = new import14.Toolbar(this.parentInjector.get(import30.ViewController, null), this.parentInjector.get(import26.Config), new import25.ElementRef(this._el_4), this.renderer);
        ...
        this._ToolbarTitle_6_4 = new import15.ToolbarTitle(this.parentInjector.get(import26.Config), new import25.ElementRef(this._el_6), this.renderer, this._Toolbar_4_4, this.parentInjector.get(import33.Navbar, null));
        ...
        var compView_11 = import34.viewFactory_Content0(this.viewUtils, this.injector(11), this._appEl_11);
        this._Content_11_4 = new import16.Content(this.parentInjector.get(import26.Config), new import25.ElementRef(this._el_11), this.renderer, this.parentInjector.get(import35.App), this.parentInjector.get(import27.Keyboard), this.parentInjector.get(import28.NgZone), this.parentInjector.get(import30.ViewController, null), this.parentInjector.get(import36.Tabs, null));
        ...
        this._el_17 = this.renderer.createElement(this._el_13, 'ion-list-header', null);
        ...
        this._ListHeader_17_5 = new import20.ListHeader(this.parentInjector.get(import26.Config), this.renderer, new import25.ElementRef(this._el_17), null);
        this._query_Label_17_0 = new import12.QueryList();
        this._query_Button_17_1 = new import12.QueryList();
        this._query_Icon_17_2 = new import12.QueryList();
        ...
        this._anchor_20 = this.renderer.createTemplateAnchor(this._el_13, null);
        ...
        this._el_26 = this.renderer.createElement(parentRenderNode, 'ion-nav', null);
        ...
        var compView_26 = import41.viewFactory_Nav0(this.viewUtils, this.injector(26), this._appEl_26);
        this._Nav_26_4 = new import22.Nav(this.parentInjector.get(import30.ViewController, null), this.parentInjector.get(import42.NavControllerBase, null), this.parentInjector.get(import35.App), this.parentInjector.get(import26.Config), this.parentInjector.get(import27.Keyboard), new import25.ElementRef(this._el_26), this.parentInjector.get(import28.NgZone), this.renderer, this.parentInjector.get(import43.ComponentFactoryResolver), this.parentInjector.get(import29.GestureController), this.parentInjector.get(import44.TransitionController), this.parentInjector.get(import45.DeepLinker, null));
        this._appEl_26.initComponent(this._Nav_26_4, [], compView_26);
        compView_26.create(this._Nav_26_4, [], null);
    ...
    _View_MyApp0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import19.Item) && ((17 <= requestNodeIndex) && (requestNodeIndex <= 18)))) {
            return this._Item_17_4;
        }
        if (((token === import20.ListHeader) && ((17 <= requestNodeIndex) && (requestNodeIndex <= 18)))) {
            return this._ListHeader_17_5;
        }
        if (((token === import37.TemplateRef) && (20 === requestNodeIndex))) {
            return this._TemplateRef_20_5;
        }
        if (((token === import21.NgFor) && (20 === requestNodeIndex))) {
            return this._NgFor_20_6;
        }
        if (((token === import17.List) && ((13 <= requestNodeIndex) && (requestNodeIndex <= 21)))) {
            return this._List_13_3;
        }
        if (((token === import16.Content) && ((11 <= requestNodeIndex) && (requestNodeIndex <= 22)))) {
            return this._Content_11_4;
        }
        if (((token === import13.Menu) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 23)))) {
            return this._Menu_0_4;
        }
        if (((token === import22.Nav) && (26 === requestNodeIndex))) {
            return this._Nav_26_4;
        }
        return notFoundResult;
    };
    _View_MyApp0.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        var currVal_3 = this.context.isHome;
        ...
        if (!throwOnChange) {
            if ((this.numberOfChecks === 0)) {
                this._Nav_26_4.ngAfterViewInit();
            }
        }
    };
...
var _View_MyApp1 = (function (_super) {
    ...
    _View_MyApp1.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import47.Icon) && (2 === requestNodeIndex))) {
        ...
        if (((token === import46.MenuClose) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 3)))) {
    ...
    _View_MyApp1.prototype._handle_click_0_0 = function ($event) {
        ...
        var pd_0 = (this.parent.context.openHome() !== false);
...
var _View_MyApp2 = (function (_super) {
    ...
    _View_MyApp2.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import19.Item) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) {
            return this._Item_0_4;
        }
        if (((token === import19.ItemContent) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) {
            return this._ItemContent_0_5;
        }
        if (((token === import46.MenuClose) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) {
            return this._MenuClose_0_6;
        }
        return notFoundResult;
    };
