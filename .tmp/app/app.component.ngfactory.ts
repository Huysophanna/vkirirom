...
import * as import11 from '@ionic/cloud-angular/dist/es5/index';
...
class _View_MyApp_Host0 extends import1.AppView<any> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._MyApp_0_4 = new import3.MyApp(this.parentInjector.get(import8.Platform),this.parentInjector.get(import9.LoadingController),this.parentInjector.get(import10.Storage),this.parentInjector.get(import11.Push));
...
class _View_MyApp0 extends import1.AppView<import3.MyApp> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._Menu_0_4 = new import15.Menu(this.parentInjector.get(import24.MenuController),new import25.ElementRef(this._el_0),this.parentInjector.get(import26.Config),this.parentInjector.get(import8.Platform),this.renderer,this.parentInjector.get(import27.Keyboard),this.parentInjector.get(import28.NgZone),this.parentInjector.get(import29.GestureController));
    ...
    this._Header_2_3 = new import16.Header(this.parentInjector.get(import26.Config),new import25.ElementRef(this._el_2),this.renderer,this.parentInjector.get(import30.ViewController,(null as any)));
    ...
    this._Toolbar_4_4 = new import16.Toolbar(this.parentInjector.get(import30.ViewController,(null as any)),this.parentInjector.get(import26.Config),new import25.ElementRef(this._el_4),this.renderer);
    ...
    this._ToolbarTitle_6_4 = new import17.ToolbarTitle(this.parentInjector.get(import26.Config),new import25.ElementRef(this._el_6),this.renderer,this._Toolbar_4_4,this.parentInjector.get(import33.Navbar,(null as any)));
    ...
    this._Content_11_4 = new import18.Content(this.parentInjector.get(import26.Config),new import25.ElementRef(this._el_11),this.renderer,this.parentInjector.get(import35.App),this.parentInjector.get(import27.Keyboard),this.parentInjector.get(import28.NgZone),this.parentInjector.get(import30.ViewController,(null as any)),this.parentInjector.get(import36.Tabs,(null as any)));
    ...
    this._List_13_3 = new import19.List(this.parentInjector.get(import26.Config),new import25.ElementRef(this._el_13),this.renderer,this.parentInjector.get(import29.GestureController));
    ...
    this._TemplateRef_17_5 = new import37.TemplateRef_(this._appEl_17,viewFactory_MyApp2);
    this._NgFor_17_6 = new import21.NgFor(this._appEl_17.vcRef,this._TemplateRef_17_5,this.parentInjector.get(import38.IterableDiffers),this.ref);
    ...
    var compView_23:any = import39.viewFactory_Nav0(this.viewUtils,this.injector(23),this._appEl_23);
    this._Nav_23_4 = new import22.Nav(this.parentInjector.get(import30.ViewController,(null as any)),this.parentInjector.get(import40.NavControllerBase,(null as any)),this.parentInjector.get(import35.App),this.parentInjector.get(import26.Config),this.parentInjector.get(import27.Keyboard),new import25.ElementRef(this._el_23),this.parentInjector.get(import28.NgZone),this.renderer,this.parentInjector.get(import41.ComponentFactoryResolver),this.parentInjector.get(import29.GestureController),this.parentInjector.get(import42.TransitionController),this.parentInjector.get(import43.DeepLinker,(null as any)));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import16.Toolbar) && ((4 <= requestNodeIndex) && (requestNodeIndex <= 8)))) { return this._Toolbar_4_4; }
    if (((token === import16.Header) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 9)))) { return this._Header_2_3; }
    ...
    if (((token === import21.NgFor) && (17 === requestNodeIndex))) { return this._NgFor_17_6; }
    if (((token === import19.List) && ((13 <= requestNodeIndex) && (requestNodeIndex <= 18)))) { return this._List_13_3; }
    if (((token === import18.Content) && ((11 <= requestNodeIndex) && (requestNodeIndex <= 19)))) { return this._Content_11_4; }
    if (((token === import15.Menu) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 20)))) { return this._Menu_0_4; }
    if (((token === import22.Nav) && (23 === requestNodeIndex))) { return this._Nav_23_4; }
    return notFoundResult;
  }
...
class _View_MyApp1 extends import1.AppView<any> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._Item_0_4 = new import44.Item(this.parent.parentInjector.get(import48.Form),this.parent.parentInjector.get(import26.Config),new import25.ElementRef(this._el_0),this.renderer);
    this._ItemContent_0_5 = new import44.ItemContent();
    this._MenuClose_0_6 = new import45.MenuClose(this.parent.parentInjector.get(import24.MenuController));
    ...
    this._Icon_2_3 = new import46.Icon(this.parent.parentInjector.get(import26.Config),new import25.ElementRef(this._el_2),this.renderer);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import46.Icon) && (2 === requestNodeIndex))) { return this._Icon_2_3; }
    if (((token === import44.Item) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 3)))) { return this._Item_0_4; }
    if (((token === import44.ItemContent) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 3)))) { return this._ItemContent_0_5; }
    if (((token === import45.MenuClose) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 3)))) { return this._MenuClose_0_6; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    const currVal_2:any = '';
...
class _View_MyApp2 extends import1.AppView<any> {
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import44.ItemContent) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) { return this._ItemContent_0_5; }
    if (((token === import45.MenuClose) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) { return this._MenuClose_0_6; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    const currVal_2:any = '';
