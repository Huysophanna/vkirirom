...
class _View_Category_Host0 extends import1.AppView<any> {
  ...
  _Category_0_4:import3.Category;
  constructor(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement) {
    super(_View_Category_Host0,renderType_Category_Host,import6.ViewType.HOST,viewUtils,parentInjector,declarationEl,import7.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._appEl_0.initComponent(this._Category_0_4,([] as any[]),compView_0);
    compView_0.create(this._Category_0_4,this.projectableNodes,(null as any));
    this.init(([] as any[]).concat([this._el_0]),[this._el_0],([] as any[]),([] as any[]));
    return this._appEl_0;
  }
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import3.Category) && (0 === requestNodeIndex))) { return this._Category_0_4; }
    return notFoundResult;
  }
}
function viewFactory_Category_Host0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<any> {
  if ((renderType_Category_Host === (null as any))) { (renderType_Category_Host = viewUtils.createRenderComponentType('',0,import11.ViewEncapsulation.None,([] as any[]),{})); }
  return new _View_Category_Host0(viewUtils,parentInjector,declarationEl);
}
export const CategoryNgFactory:import12.ComponentFactory<import3.Category> = new import12.ComponentFactory<import3.Category>('page-category',viewFactory_Category_Host0,import3.Category);
const styles_Category:any[] = ([] as any[]);
var renderType_Category:import0.RenderComponentType = (null as any);
class _View_Category0 extends import1.AppView<import3.Category> {
  _text_0:any;
  _el_1:any;
  ...
  /*private*/ _expr_8:any;
  constructor(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement) {
    super(_View_Category0,renderType_Category,import6.ViewType.COMPONENT,viewUtils,parentInjector,declarationEl,import7.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import2.AppElement {
    const parentRenderNode:any = this.renderer.createViewRoot(this.declarationAppElement.nativeElement);
    this._text_0 = this.renderer.createText(parentRenderNode,'\n',(null as any));
    this._el_1 = this.renderer.createElement(parentRenderNode,'ion-header',(null as any));
    this._Header_1_3 = new import13.Header(this.parentInjector.get(import22.Config),new import23.ElementRef(this._el_1),this.renderer,this.parentInjector.get(import24.ViewController,(null as any)));
    ...
    this._Navbar_3_4 = new import14.Navbar(this.parentInjector.get(import26.App),this.parentInjector.get(import24.ViewController,(null as any)),this.parentInjector.get(import8.NavController,(null as any)),this.parentInjector.get(import22.Config),new import23.ElementRef(this._el_3),this.renderer);
    ...
    this._MenuToggle_5_5 = new import16.MenuToggle(this.parentInjector.get(import28.MenuController),new import23.ElementRef(this._el_5),this.parentInjector.get(import24.ViewController,(null as any)),this._Navbar_3_4);
    this._ToolbarItem_5_6 = new import17.ToolbarItem(this.parentInjector.get(import22.Config),new import23.ElementRef(this._el_5),this.renderer,this.parentInjector.get(import13.Toolbar,(null as any)),this._Navbar_3_4);
    ...
    this._ToolbarTitle_10_4 = new import20.ToolbarTitle(this.parentInjector.get(import22.Config),new import23.ElementRef(this._el_10),this.renderer,this.parentInjector.get(import13.Toolbar,(null as any)),this._Navbar_3_4);
    ...
    this._Content_15_4 = new import21.Content(this.parentInjector.get(import22.Config),new import23.ElementRef(this._el_15),this.renderer,this.parentInjector.get(import26.App),this.parentInjector.get(import31.Keyboard),this.parentInjector.get(import32.NgZone),this.parentInjector.get(import24.ViewController,(null as any)),this.parentInjector.get(import33.Tabs,(null as any)));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import21.Content) && ((15 <= requestNodeIndex) && (requestNodeIndex <= 16)))) { return this._Content_15_4; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    const currVal_7:any = import4.interpolate(1,'category ',this.context.title,'');
...
export function viewFactory_Category0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.Category> {
